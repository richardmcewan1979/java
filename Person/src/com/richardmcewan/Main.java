...
public class Main {
	...
	// write your code here
        ...
        person.setFirstName("Richard");   // firstName is set to empty string
        person.setLastName("McEwan");    // lastName is set to empty string
        person.setAge(41);
        System.out.println("fullName= " + person.getFullName());
        System.out.println("teen= " + person.isTeen());

        //note changes first name but last remains the same
